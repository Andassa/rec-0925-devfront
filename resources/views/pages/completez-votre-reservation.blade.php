    ...
    <div class="grid md:grid-cols-3 gap-12 items-stretch">
            ...
            <div class="p-6 flex flex-col flex-1">
                ...
                <div class="text-center flex flex-col items-center mb-6">
                    ...
                    <button class="bg-gray-100 hover:bg-gray-200 text-gray-700 py-3 px-10 rounded-xl font-medium transition-colors flex items-center justify-center gap-2 shadow-md hover:shadow-lg">
                        <div class="w-3 h-3 bg-white rounded-full"></div> Sélectionner
                    </button>
                </div>
                ...
                <div class="space-y-4 flex-1">
                    <div class="flex items-start gap-3">
                        <img src="{{ asset('assets/logo/cursor-hand-click-svgrepo-com.svg') }}" alt="Cursor click icon" class="w-6 h-6 flex-shrink-0 mt-0.5"/>
                        <span class="text-sm text-gray-700">Entraînement illimité et gratuit</span>
                    </div>
                    <div class="flex items-start gap-3">
                        <img src="{{ asset('assets/logo/check-mark-circle-svgrepo-com-noire.svg') }}" alt="Check mark icon" class="w-6 h-6 flex-shrink-0 mt-0.5"/>
        ...
        <div class="bg-white rounded-3xl shadow-sm border-4 border-[#0dbc0d] overflow-hidden flex flex-col min-h-[600px]">
            ...
            <div class="p-6 flex flex-col flex-1">
                ...
                <div class="space-y-4 flex-1">
                    <div class="flex items-start gap-3">
                        <img src="{{ asset('assets/logo/cursor-hand-click-svgrepo-com-vert.svg') }}" alt="Cursor click icon" class="w-6 h-6 flex-shrink-0 mt-0.5"/>
                        <span class="text-sm text-gray-700">Entraînement illimité et gratuit</span>
                    </div>
                    <div class="flex items-start gap-3">
                        <img src="{{ asset('assets/logo/check-mark-circle-svgrepo-com.svg') }}" alt="Check mark icon" class="w-6 h-6 flex-shrink-0 mt-0.5"/>
                        <span class="text-sm text-gray-700">Annulation jusqu'à 48 heures</span>
                    </div>
                    <div class="flex items-start gap-3">
                        <img src="{{ asset('assets/logo/refresh-svgrepo-com-vert.svg') }}" alt="Refresh icon" class="w-6 h-6 flex-shrink-0 mt-0.5"/>
                    ...
                    <div class="flex items-start gap-3">
                        <img src="{{ asset('assets/logo/book-svgrepo-com-vert.svg') }}" alt="Book icon" class="w-6 h-6 flex-shrink-0 mt-0.5"/>
        ...
        <div class="bg-white rounded-3xl shadow-sm border border-gray-200 overflow-hidden flex flex-col min-h-[600px]">
            ...
            <div class="p-6 flex flex-col flex-1">
                ...
                <div class="text-center flex flex-col items-center mb-6">
                    ...
                    <button class="text-white py-3 px-10 rounded-xl font-medium transition-colors flex items-center justify-center gap-2" style="background-color: #36578a;" onmouseover="this.style.backgroundColor='#2b466f';" onmouseout="this.style.backgroundColor='#36578a';">
                        <div class="w-3 h-3 bg-white rounded-full"></div> Sélectionner
                    </button>
                </div>
                <hr class="border-gray-200 mb-6 -mx-6">
                ...
                <div class="space-y-4 flex-1">
                    <div class="flex items-start gap-3">
                        <img src="{{ asset('assets/logo/cursor-hand-click-svgrepo-com-blueu.svg') }}" alt="Cursor click icon" class="w-6 h-6 flex-shrink-0 mt-0.5"/>
                        <span class="text-sm text-gray-700">Entraînement illimité et gratuit</span>
                    </div>
                    <div class="flex items-start gap-3">
                        <img src="{{ asset('assets/logo/check-mark-circle-svgrepo-com-bleue.svg') }}" alt="Check mark icon" class="w-6 h-6 flex-shrink-0 mt-0.5"/>
                        <span class="text-sm text-gray-700 font-bold">Annulation jusqu'à 48 heures</span>
                    </div>
                    <div class="flex items-start gap-3">
                        <img src="{{ asset('assets/logo/refresh-svgrepo-com-bleue.svg') }}" alt="Refresh icon" class="w-6 h-6 flex-shrink-0 mt-0.5"/>
                        <span class="text-sm text-gray-700 font-bold">Repassez votre test pour 0€ (si test échoué)</span>
                    </div>
                    <div class="flex items-start gap-3">
                    ...
                    <div class="flex items-start gap-3">
                        <img src="{{ asset('assets/logo/book-svgrepo-com-bleue.svg') }}" alt="Book icon" class="w-6 h-6 flex-shrink-0 mt-0.5"/>
                        <span class="text-sm text-gray-700">Livret de préparation au test psychotechnique</span>
                    </div>
                    <div class="flex items-start gap-3">
                        <img src="{{ asset('assets/logo/download-minimalistic-svgrepo-com.svg') }}" alt="Download icon" class="w-6 h-6 flex-shrink-0 mt-0.5"/>
